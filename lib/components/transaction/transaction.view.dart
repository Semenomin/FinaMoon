...
class TransactionView extends StatefulWidget {
  ...
  TransactionView({Key key, this.transactionId, this.currency, this.ctx})
      : super(key: key);
...
class TransactionViewState extends State<TransactionView> {
  ...
  String customNumberFormat(String currency, int digits, double format) {
    return NumberFormat.currency(name: currency, decimalDigits: digits)
        .format(format);
  }
  ...
  getTransactionById() async {
    ...
    this.setState(() {
      ...
      transactionData.transactionDate = new DateFormat('dd/MM/yyyy')
          .format(DateTime.parse(transaction.transactionDate));

      if (transaction.expiryDate != null) {
        transactionData.expiryDate = new DateFormat('dd/MM/yyyy')
        ...
        int paidMonths = expiryDate.diff(today, "month") <= 0
            ? totalMonths
            : startDate.diff(today, "month").abs();
        ...
        transactionData.totalAmountUnpaid = customNumberFormat(
            widget.currency,
            2,
            totalMonths * transaction.amount - paidMonths * transaction.amount);
            ...
            (transactionData.expiryDate != null)
                ? new Padding(
                    ...
                    child: Row(
                        ...
                        children: <Widget>[
                          new Text("Duration (Months)",
                              style:
                                  Theme.of(context).textTheme.display1.copyWith(
                                        color: Colors.white,
                                        fontSize: 20,
                                      )),
                          new Text(transactionData.duration.toString(),
            ...
            (transactionData.expiryDate != null)
                ? new Padding(
                    ...
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          new Text("Duration passed (Months)",
                              style:
                                  Theme.of(context).textTheme.display1.copyWith(
                                        color: Colors.white,
                                        fontSize: 20,
                                      )),
                          new Text(transactionData.durationPassed.toString(),
                              style: Theme.of(context)
                                  .textTheme
                                  .display1
                                  .copyWith(
                ...
                ? new Padding(
                    ...
                    child: new Row(
                        ...
                        children: <Widget>[
                          ...
                          new Text(transactionData.totalAmount.toString(),
                              style: Theme.of(context)
                                  .textTheme
                                  .display1
                                  .copyWith(
                ...
                children: <Widget>[
                  new Padding(
                    ...
                    child: MaterialButton(
                      ...
                      height: 37.0,
                      onPressed: () {
                        BlocProvider.of<HomeBloc>(widget.ctx).add(
                            OpenEditTransactionPageEvent(
